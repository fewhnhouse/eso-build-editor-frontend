...
import { defaultRaidState, IRaidState } from '../../raid/RaidStateContext';
              ...
              <>
                ...
                <CardList direction={"row"} justify={""} align={""}>
                  {role.builds.map(build => {
                    return (
                      <StyledCard hoverable title={build.name}>{build.description}</StyledCard>
                    )
                  })}
                </CardList>
              </>
